...
public class SearchExpandedCommand implements Command{
    private final Input inputInterface;
    private final Output outputInterface;
    public SearchExpandedCommand(Input inputInterface, Output outputInterface) {
