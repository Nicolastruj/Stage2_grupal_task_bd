...
public class SearchEngineExpandedCommand implements Command {
    private final Input input;
    private final Output outputInterface;
    private final QueryEngineExpanded queryEngine;

    public SearchEngineExpandedCommand(Input inputInterface, Output outputInterface, QueryEngineExpanded queryEngine) {
