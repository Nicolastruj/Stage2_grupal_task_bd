...
import org.ulpgc.control.SearchEngineExpandedCommand;
...
public class MainExpanded {
    public static void main(String[] args) throws QueryEngineException {
        ...
        Command searchEngineCommand = new SearchEngineExpandedCommand(input, output, queryEngine);
